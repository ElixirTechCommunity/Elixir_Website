    ...
    <div className=' p-5 w-full rounded-md bg-neutral-950 relative flex flex-col items-center justify-center antialiased'>
      <div className='h-auto w-full flex flex-col gap-[3vw] items-center justify-center overflow-hidden rounded-md m-[2vw]'>
        ...
        <div className='text-white'>
          <div>Don't worry! We don't take Guru Dakshina</div>
          <div className='flex flex-row gap-2 justify-center items-center rounded-full relative'>
            ...
            ></input>
            <button
              className='absolute right-1 min-w-9 min-h-7 bg-gradient-to-r from-indigo-500 to-purple-500 hover:bg-[#490669] flex flex-row gap-2 justify-center items-center md:py-1 p-1 md:px-2 rounded-full'
              onClick={loadMentor}
            >
              <span className='text-white font-semibold'>
                <FaSearch color='white' className='text-lg' />
              </span>
            </button>
          </div>
        </div>
