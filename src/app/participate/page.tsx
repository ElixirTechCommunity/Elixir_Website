...
import { Gradient } from "@/components/participate/Gradient";
...
function Participate() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            console.log(name, fromEmail, issue);
            ...
            if (response.error) {
                ...
                if (nameRef.current && fromEmailRef.current && issueRef.current)
    ...
    return (
        <div className="h-[100vh] w-full rounded-md bg-neutral-950 relative flex flex-col items-center justify-center antialiased object-contain">
